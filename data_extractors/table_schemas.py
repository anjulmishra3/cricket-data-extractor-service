...
balls = Table("balls", meta,
              Column("match_id", Integer, ForeignKey("matches.match_id"), default=None, primary_key=True),
              Column("tournament_id", Integer, ForeignKey("tournaments.tournament_id"), default=None),
              Column("venue_id", Integer, ForeignKey("venues.venue_id"), default=None),
              Column("team_id", Integer, ForeignKey("teams.team_id"), default=None),
              Column("over", Integer, default=None, primary_key=True),
              Column("ball_num", Integer, default=None, primary_key=True),
              Column("innings", Integer, default=None, primary_key=True),
              Column("batter", Integer, ForeignKey("players.player_id"), default=None),
              Column("non_striker", Integer, ForeignKey("players.player_id"), default=None),
              Column("bowler", Integer, ForeignKey("players.player_id"), default=None),
              Column("speed", Float, default=None),
              Column("catcher", Integer, default=None),
              Column("dismissal_desc", String(100), default=None),
              Column("total_extras", Integer, default=None),
              Column("runs", Integer, default=None),
              Column("bowler_extras", Integer, default=None),
              Column("extra_type", String(40), default=None),
              Column("otw", Boolean, default=None),
              Column("length", Float, default=None),
              Column("line", Float, default=None),
              Column("line_at_stumps", Float, default=None),
              Column("height_at_stumps", Float, default=None),
              Column("shot_dist0", Float, default=None),
              Column("shot_dist1", Float, default=None),
              Column("blank2", Integer, default=None),
              Column("blank3", Integer, default=None),
              Column("blank4", Integer, default=None),
              )
