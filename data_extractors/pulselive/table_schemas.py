...
balls = Table("balls", meta,
              ...
              Column("over_number", Integer, default=None, primary_key=True),
              Column("ball_number", Integer, default=None, primary_key=True),
              Column("innings_number", Integer, default=None, primary_key=True),
              Column("over_ball", Integer, default=None, primary_key=True),
              Column("batsman", Integer, ForeignKey("players.player_id"), default=None),
              ...
              Column("speed_kmph", Float, default=None),
              Column("catcher", Integer, default=None),
              Column("dismissal_description", String(100), default=None),
              ...
              Column("length_on_pitching", Float, default=None),
              Column("line_on_pitching", Float, default=None),
              Column("line_at_stumps", Float, default=None),
              Column("height_at_stumps", Float, default=None),
              Column("shot_x", Float, default=None),
              Column("shot_y", Float, default=None)
              )
